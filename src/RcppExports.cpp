...
// compute_velocity_via_ek
NumericVector compute_velocity_via_ek(NumericVector x, IntegerVector trial, int time_window_in_samples, float delta_t);
RcppExport SEXP _saccadr_compute_velocity_via_ek(SEXP xSEXP, SEXP trialSEXP, SEXP time_window_in_samplesSEXP, SEXP delta_tSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(compute_velocity_via_ek(x, trial, time_window_in_samples, delta_t));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_saccadr_compute_velocity_via_ek", (DL_FUNC) &_saccadr_compute_velocity_via_ek, 4},
    {NULL, NULL, 0}
};
